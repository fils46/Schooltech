  ...
  if (!consultation) {
    return (
      <div className="flex flex-col items-center justify-center h-48 gap-3">
        <p className="text-slate-400">Consultation introuvable.</p>
        <Button variant="outline" onClick={() => navigate("/infirmerie")} className="border-slate-600 text-slate-300">
          Retour
        </Button>
      </div>
    );
        ...
        <div className="space-y-4">
            ...
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                {(dossier.allergies?.length ?? 0) > 0 && (
                  <div>
                    <p className="text-slate-400 mb-1">Allergies</p>
                ...
                {dossier.medicaments_interdits && (
                  <div className="flex items-start gap-1">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-xs">{dossier.medicaments_interdits}</p>
                    </div>
                  </div>
                )}
                <div className="flex items-center justify-between pt-1 border-t border-slate-700">
                  <span className="text-slate-400">Visites totales</span>
                  <span className="text-slate-200 font-semibold">{dossier.nb_visites}</span>
                </div>
              </CardContent>
            </Card>
          )}
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-slate-400">Infirmier(e)</span>
                <span className="text-slate-200">{consultation.infirmier_nom ?? "—"}</span>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="md:col-span-2 space-y-4">
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-slate-300">Médicaments donnés</Label>
                <Input
                  value={medicaments}
