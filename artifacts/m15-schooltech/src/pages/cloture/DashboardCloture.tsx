  ...
  return (
    <div className="min-h-screen bg-[#F0F4FF] dark:bg-[#0A1628] text-[#0A1628] dark:text-white p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-[#0A1628] dark:text-white" style={{ fontFamily: "Poppins, sans-serif" }}>
            Clôture d'année scolaire
          </h1>
          <p className="text-[#5A6B8C] dark:text-[#8B9DC3] mt-1">Gérez les décisions de fin d'année et les promotions</p>
        </div>
        <div className="flex items-center gap-3">
          <Select value={selectedAnnee} onValueChange={setAnneeId}>
            <SelectTrigger className="w-52 bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)] text-[#0A1628] dark:text-white">
              <SelectValue placeholder="Sélectionner une année" />
            </SelectTrigger>
            <SelectContent className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)]">
              {annees.map(a => (
                <SelectItem key={a.id} value={a.id} className="text-[#0A1628] dark:text-white hover:bg-[#E0E8F8] dark:hover:bg-[#F0F4FF] dark:bg-[#0A1628]">
          ...
          <Card key={s.label} className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)]">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[#5A6B8C] dark:text-[#8B9DC3] text-xs">{s.label}</span>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <Card className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)]">
          <CardContent className="p-4 flex items-center gap-4">
            ...
            <div>
              <div className="text-[#5A6B8C] dark:text-[#8B9DC3] text-sm">Taux de réussite</div>
              <div className="text-3xl font-bold text-[#00C9A7]">{totaux.taux_reussite}%</div>
            </div>
          </CardContent>
        </Card>
        <Card className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)] cursor-pointer hover:border-[#00C9A7]/40 transition-colors"
          onClick={() => navigate("/cloture/criteres")}>
          <CardContent className="p-4 flex items-center gap-3">
            <Settings className="w-6 h-6 text-[#F5C842]" />
            <div className="flex-1">
              <div className="font-semibold text-[#0A1628] dark:text-white">Critères d'admission</div>
              <div className="text-[#5A6B8C] dark:text-[#8B9DC3] text-sm">Configurer les seuils</div>
            </div>
            <ChevronRight className="w-4 h-4 text-[#5A6B8C] dark:text-[#8B9DC3]" />
          </CardContent>
        </Card>
        <Card className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)] cursor-pointer hover:border-[#00C9A7]/40 transition-colors"
          ...
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="font-semibold text-[#0A1628] dark:text-white">Validation & Promotion</div>
              <div className="text-[#5A6B8C] dark:text-[#8B9DC3] text-sm">Lancer les promotions</div>
            </div>
            <ChevronRight className="w-4 h-4 text-[#5A6B8C] dark:text-[#8B9DC3]" />
          </CardContent>
        </Card>
      ...
      {/* Tableau par classe */}
      <Card className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)] mb-8">
        <CardContent className="p-0">
          <div className="p-4 border-b border-[rgba(0,0,0,0.06)] dark:border-[rgba(0,201,167,0.10)]">
            <h2 className="font-bold text-[#0A1628] dark:text-white text-lg">Récapitulatif par classe</h2>
          </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {parClasse.length === 0 ? (
                  ...
                  <tr key={c.classe_id}
                    className={cn(
                      "border-b border-[rgba(0,0,0,0.04)] dark:border-[rgba(0,201,167,0.07)] hover:bg-[#E0E8F8] dark:hover:bg-[#F0F4FF] dark:bg-[#0A1628]/40 transition-colors",
                      c.sans_decision > 0 && "bg-[#FF4D6D]/5"
                    )}>
                    <td className="p-3 font-semibold text-[#0A1628] dark:text-white">{c.classe_nom}</td>
                    <td className="text-center p-3 text-[#5A6B8C] dark:text-[#8B9DC3]">{c.total}</td>
                    ...
                    <td className="text-center p-3 text-[#5A6B8C] dark:text-[#8B9DC3]">{c.sortie}</td>
                    ...
                    <td className="text-center p-3">
                      <Button
                        size="sm"
                        className="bg-[#0080FF] hover:bg-[#0080FF]/80 text-[#0A1628] dark:text-white text-xs px-3"
      ...
      <Card className="bg-white dark:bg-[#111E35] border-[rgba(0,0,0,0.08)] dark:border-[rgba(0,201,167,0.15)]">
        <CardContent className="p-4">
          <h2 className="font-bold text-[#0A1628] dark:text-white text-lg mb-4">Étapes de clôture</h2>
            ...
            {[
              ...
              <div key={etape.label} className="flex items-center gap-2 flex-1">
                <div className={cn(
                  ...
                  etape.done ? "bg-[#00C9A7] text-[#0A1628]" : "bg-[#F0F4FF] dark:bg-[#0A1628] border border-[#8B9DC3] text-[#5A6B8C] dark:text-[#8B9DC3]"
                )}>
                  {etape.done ? "✓" : idx + 1}
                </div>
                <div className={cn("text-sm", etape.done ? "text-[#00C9A7]" : "text-[#5A6B8C] dark:text-[#8B9DC3]")}>
                  {etape.label}
                </div>
                {idx < 4 && <ArrowRight className="w-3 h-3 text-[#5A6B8C] dark:text-[#8B9DC3] hidden sm:block" />}
              </div>
            ))}
          </div>
        </CardContent>
